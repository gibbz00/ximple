...
pub fn derive(enum_ident: &Ident, data_enum: DataEnum) -> syn::Result<TokenStream2> {
...
fn unit(enum_ident: &Ident, variant_ident: &Ident) -> syn::Result<TokenStream2> {
...
fn unnamed(enum_ident: &Ident, variant_ident: &Ident, fields: FieldsUnnamed) -> syn::Result<TokenStream2> {
    let element_name = variant_ident.to_string();
...
fn named(enum_ident: &Ident, variant_ident: &Ident, fields: FieldsNamed) -> syn::Result<TokenStream2> {
    let element_name = variant_ident.to_string();
